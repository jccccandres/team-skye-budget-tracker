...
DROP FUNCTION IF EXISTS public.create_transfer(NUMERIC, DATE, TEXT, TEXT, UUID, TEXT, UUID, UUID, UUID, UUID, NUMERIC, TEXT) CASCADE;
DROP FUNCTION IF EXISTS public.get_wallet_peer_emails(UUID[]) CASCADE;
DROP FUNCTION IF EXISTS public.get_wallet_totals(UUID, DATE, DATE) CASCADE;
