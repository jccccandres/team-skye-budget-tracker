...
import type { GroceryItem, GroceryItemCategory } from '../types/database'

const sections: { category: GroceryItemCategory; label: string }[] = [
  { category: 'meat_frozen', label: 'Meat & Frozen' },
  { category: 'fruits_veggies', label: 'Fruits & Vegetables' },
  { category: 'pantry_snacks', label: 'Pantry & Snacks' },
  { category: 'household_cleaning', label: 'Household & Cleaning' },
]
